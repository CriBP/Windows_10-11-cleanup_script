...
echo -%Green% Disable Remote Assistance: Created by: Shawn Brink on: August 27th 2018echo -%Green% Tutorial: %Cyan% https://www.tenforums.com/tutorials/116749-enable-disable-remote-assistance-connections-windows.html %Reset%
