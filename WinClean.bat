...
reg add "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\HideDesktopIcons\NewStartPanel" /f /v "{4564b25e-30cd-4787-82ba-39e73a750b14}" /t REG_DWORD /d "0"
:: add Recent folders
...
:: A value of '1' hides the icon on the Desktop; a value of `0` displays it.
reg add "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\HideDesktopIcons\NewStartPanel" /f /v "{22877a6d-37a1-461a-91b0-dbda5aaebc99}" /t REG_DWORD /d "0"
:: Icons Layout
